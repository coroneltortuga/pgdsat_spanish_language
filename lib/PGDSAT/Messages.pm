...
#-----------------------------------------------------------------------------
	'es_ES' => {
#-----------------------------------------------------------------------------
		'0.1' => { 'errmsg' => 'Prueba superada'},
		'1.1' => { 'errmsg' => 'No se han encontrado paquetes PostgreSQL.' },
		'1.2' => { 'errmsg' => 'Los paquetes PostgreSQL no son del repositorio PGDG.' },
		'1.3' => { 'errmsg' => 'No hay acceso a Internet en https://www.postgresql.org/.' },
		'1.4' => { 'errmsg' => 'Esta versión de PostgreSQL, v%s, ya no está soportada.' },
		'1.5' => { 'errmsg' => 'Esta versión de PostgreSQL, v%s, no es la última versión de esta rama (%s)' },
		'1.6' => { 'errmsg' => 'Consulte <a href="https://why-upgrade.depesz.com/show?from=%s&to=%s" target="_new">Por qué actualizar</a>.' },
		'1.7' => { 'errmsg' => 'La versión %s de PostgreSQL no está habilitada como servicio systemd.' },
		'1.8' => { 'errmsg' => 'PostgreSQL systemd service must not be enabled when patroni is used.' },
		'1.9' => { 'errmsg' => 'Wrong or no base directory found, the PGDATA (%s) must be initialized first (see initdb).' },
		'1.10' => { 'errmsg' => 'The version of the PGDATA (%s) does not correspond to the PostgreSQL cluster version; You need to upgrade the PGDATA v%s to v%s first.' },
		'1.11' => { 'errmsg' => 'Checksum are not enabled in PGDATA %s.' },
