...
L<CIS compliance benchmark|https://www.cisecurity.org/cis-benchmarks/>
but not only.
...
See L<sample report|https://www.darold.net/sample_pgdsat/report.html>.
...
Some parts are copied from the L<CIS Benchmark|https://www.cisecurity.org/cis-benchmarks>
licensed under the L<Creative Common Version 4.0|https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode>
terms of use.
